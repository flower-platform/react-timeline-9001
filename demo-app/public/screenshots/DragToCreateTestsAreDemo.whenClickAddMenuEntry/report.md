...
### WHEN click on the 'Drag To Create' menu entry, THEN the Gantt goes into the 'drag to create mode' and the drag to create popup appears
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/Timeline_menuButton.png <br/>
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/ContextMenu_popup_ContextMenu_menuItem_0.png <br/>
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/_LAP.png <br/>
![](_LAP.png)
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/Timeline_dragToCreatePopup.png <br/>
![](Timeline_dragToCreatePopup.png)

</details>
</td>
<td>

![](Timeline_dragToCreatePopup_small.png)
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/Timeline_dragToCreatePopup_Timeline_dragToCreatePopupLabel_1.png <br/>
![](Timeline_dragToCreatePopup_Timeline_dragToCreatePopupLabel_1.png)

</details>
</td>
<td>

![](Timeline_dragToCreatePopup_Timeline_dragToCreatePopupLabel_1_small.png)
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/Timeline_dragToCreatePopup_Timeline_dragToCreatePopupLabel_2.png <br/>
![](Timeline_dragToCreatePopup_Timeline_dragToCreatePopupLabel_2.png)

</details>
</td>
<td>

![](Timeline_dragToCreatePopup_Timeline_dragToCreatePopupLabel_2_small.png)
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/Timeline_dragToCreatePopup_Timeline_dragToCreatePopupLabel_3.png <br/>
![](Timeline_dragToCreatePopup_Timeline_dragToCreatePopupLabel_3.png)

</details>
</td>
<td>

![](Timeline_dragToCreatePopup_Timeline_dragToCreatePopupLabel_3_small.png)
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/Timeline_dragToCreatePopup_Timeline_dragToCreatePopupCancelButton.png <br/>
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/Timeline_dragToCreatePopup_Timeline_dragToCreatePopupCancelButton_REP1.png <br/>
![](Timeline_dragToCreatePopup_Timeline_dragToCreatePopupCancelButton_REP1.png)

</details>
</td>
<td>

![](Timeline_dragToCreatePopup_Timeline_dragToCreatePopupCancelButton_REP1_small.png)
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/_LAP_REP1.png <br/>
![](_LAP_REP1.png)
...
DragToCreateTestsAreDemo.whenClickAddMenuEntry/_LAP_REP2.png <br/>
![](_LAP_REP2.png)
