...
### WHEN I right click on a row, THEN a context menu with one action opens
...
```
Error: Uncaught TypeError: Cannot read properties of null (reading 'recomputeGridSize') (http://localhost:3000/@fs/home/poweruser/git2/react-timeline-10000/src/timeline.js:434)
...
ContextMenuTestsAreDemo.whenRightClickOnARow/Timeline_ganttBody_Timeline_row_0.png <br/>
