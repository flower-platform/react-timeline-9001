...
export class BackgroundLayersTestsAreDemo {
    ...
    async highlightedIntervalsAreDisplayed() {
        ...
        await tad.assertWaitable.approximately(Math.round(interval.getBoundingClientRect().x - ganttLeftOffset), this.getPixelsAtTime(dateAndHourOfMonth(month, 4)), 1);
        ...
        await tad.assertWaitable.exists(interval);
        await tad.assertWaitable.approximately(Math.round(interval.getBoundingClientRect().x - ganttLeftOffset), this.getPixelsAtTime(dateAndHourOfMonth(month, 11)), 1);
        ...
        await tad.assertWaitable.exists(interval);
        await tad.assertWaitable.approximately(Math.round(interval.getBoundingClientRect().x - ganttLeftOffset), this.getPixelsAtTime(dateAndHourOfMonth(month, 18)), 1);
        ...
        await tad.assertWaitable.exists(interval);
        await tad.assertWaitable.approximately(Math.round(interval.getBoundingClientRect().x - ganttLeftOffset), this.getPixelsAtTime(dateAndHourOfMonth(month, 25)), 1);
        ...
        await tad.assertWaitable.exists(interval);
        await tad.assertWaitable.approximately(Math.round(interval.getBoundingClientRect().x - ganttLeftOffset), this.getPixelsAtTime(dateAndHourOfMonth(month, 1)), 1);
        ...
        await tad.assertWaitable.exists(interval);
        await tad.assertWaitable.approximately(Math.round(interval.getBoundingClientRect().x - ganttLeftOffset), this.getPixelsAtTime(dateAndHourOfMonth(month, 15)), 1);
        ...
        await tad.assertWaitable.exists(interval);
        await tad.assertWaitable.approximately(Math.round(interval.getBoundingClientRect().x - ganttLeftOffset), this.getPixelsAtTime(dateAndHourOfMonth(month, 20, 19)), 1);
