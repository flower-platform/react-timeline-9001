...
Drag to create mechanism requires the property <code><a href={encodeApiDocURIForSubpath("/classes/Timeline.html#propTypes")}>Timeline.onDragToCreateEnded</a></code> to be set.
