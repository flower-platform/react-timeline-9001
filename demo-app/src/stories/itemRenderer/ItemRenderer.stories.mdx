...
If you create your **own subclass of `ItemRenderer`**, you may override its functions (see <a href={encodeApiDocURIForSubpath("classes/ItemRenderer.html")}>ItemRenderer API Doc</a>). Some possible scenarios:
