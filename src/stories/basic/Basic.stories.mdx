...
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getStartDate")}>Timeline.getStartDate()</a></code>
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getEndDate")}>Timeline.getEndDate()</a></code>
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getStartFromItem")}>Timeline.getStartFromItem(item)</a></code>
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getEndFromItem")}>Timeline.getEndFromItem(item)</a></code>
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-setStartToItem")}>Timeline.setStartToItem(item, newDateAsMoment)</a></code>
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-setEndToItem")}>Timeline.setEndToItem(item, newDateAsMoment)</a></code>
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getStartFromRowLayer")}>Timeline.getStartFromRowLayer(layer)</a></code>
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-getEndFromRowLayer")}>Timeline.getEndFromRowLayer(layer)</a></code>
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-setStartToRowLayer")}>Timeline.setStartToRowLayer(layer, newDateAsMoment)</a></code>
* <code><a href={encodeApiDocURIForSubpath("/class/src/timeline.js~Timeline.html#instance-method-setEndToRowLayer")}>Timeline.setEndToRowLayer(layer, newDateAsMoment)</a></code>
* <code><a href={encodeApiDocURIForSubpath("function/index.html#static-function-convertDateToMoment")}>utils: convertDateToMoment(date, useMoment)</a></code>
* <code><a href={encodeApiDocURIForSubpath("function/index.html#static-function-convertMomentToDateType")}>utils: convertMomentToDateType(dateAsMoment, useMoment)</a></code>
