...
* <a href={encodeApiDocURIForSubpath("function/index.html#convertDateToMoment")}>utils: convertDateToMoment(date, useMoment)</a>
* <a href={encodeApiDocURIForSubpath("function/index.html#convertMomentToDateType")}>utils: convertMomentToDateType(dateAsMoment, useMoment)</a>